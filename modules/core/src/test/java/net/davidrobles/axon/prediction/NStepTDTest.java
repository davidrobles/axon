...
public class NStepTDTest {
    ...
    private NStepTD<String> agent(int n) {
        return new NStepTD<>(table, n, 1.0);
    }

    private NStepTD<String> agent(int n, double gamma) {
        return new NStepTD<>(table, n, gamma);
    }
