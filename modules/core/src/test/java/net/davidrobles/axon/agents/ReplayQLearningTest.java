...
public class ReplayQLearningTest {
    ...
    private ReplayQLearning<String, String> agent(int bufferCapacity, int batchSize) {
        return new ReplayQLearning<>(
                table,
    ...
    public void noUpdateBeforeBufferReachesBatchSize() {
        ReplayQLearning<String, String> a = agent(10, 3);
    ...
    public void updatesBeginOnceBatchSizeReached() {
        ReplayQLearning<String, String> a = agent(10, 2);
    ...
    public void terminalTransitionUpdatesWithRewardOnly() {
        ...
        ReplayQLearning<String, String> a = agent(10, 1);
    ...
    public void bufferEvictsOldTransitionsWhenFull() {
        ...
        ReplayQLearning<String, String> a = agent(1, 1);
