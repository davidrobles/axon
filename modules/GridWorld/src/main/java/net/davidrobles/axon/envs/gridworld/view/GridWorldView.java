...
public abstract class GridWorldView extends JPanel implements MouseMotionListener, MouseListener {
    ...
    //                g.drawString(t, state.getX() * cellWidth, state.getY() * cellHeight +
    // cellHeight / 2);
    //            }
    //        }
    //    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (GWState gwState : gw.getStates()) {
            ...
            //                g.fillRect(gwState.getX() * cellWidth, gwState.getY() * cellHeight,
            // cellWidth, cellHeight);
            //                g.setColor(Color.WHITE);
            //                String t = String.format("%.1f", (float) gridWorld.reward(gwState));
            //                g.drawString(t, gwState.getX() * cellWidth, gwState.getY() *
            ...
            if (gridEnabled) {
                ...
                g.drawRect(
                        gwState.getX() * cellWidth,
                        gwState.getY() * cellHeight,
                        cellWidth,
                        cellHeight);
            }
        ...
        //
        //            // Left
        //            g.fillRect(state.getX() * cellWidth, state.getY() * cellHeight + (cellHeight /
        // 3),
        //                    cellWidth / 3, cellHeight / 3);
        //
        //            // Right
        //            g.fillRect(state.getX() * cellWidth + (cellWidth / 3) * 2, state.getY() *
        // cellHeight
